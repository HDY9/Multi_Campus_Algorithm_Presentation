...
dat6=pd.read_csv('Dataset_06.csv')
dat6.info()
dat6.columns
...
q1_1=dat6[dat6.waterfront == 1]['price'].mean()
q1_0=dat6[dat6.waterfront == 0]['price'].mean()
...
q2=dat6[var_list].corr()['price'].drop('price').abs()
q2
...
var_list=dat6.columns.drop(['id', 'date', 'zipcode', 'price'])

form1= 'price~' + '+'.join(var_list)

lm=ols(form1, dat6).fit()

q3=lm.params[lm.pvalues < 0.05].drop('Intercept')
q3
len(q3)
